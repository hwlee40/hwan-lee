...
$(document).ready(function () {
  var controller = new _scrollmagic.default.Controller(); //Loop

  $('.hobby').each(function () {
    var newScene = new _scrollmagic.default.Scene({
      triggerElement: this.children[0],
      triggerHook: 0.8,
      reverse: true
    }).setClassToggle(this, 'slide_in').addTo(controller);
  }); //Loop
